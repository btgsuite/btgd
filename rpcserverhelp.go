...
var helpDescsEnUS = map[string]string{
	...
	"getblockverboseresult-nonceUint32":       "The low 32 bits of the block nonce",
	...
	"getblockheaderverboseresult-nonceUint32":       "The low 32 bits of the block nonce",
	...
	// StopCmd help.
	"stop--synopsis": "Shutdown btgd.",
	"stop--result0":  "The string 'btgd stopping.'",
