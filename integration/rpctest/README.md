...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/btgsuite/btgd/integration/rpctest)
...
```bash
$ go get -u github.com/btgsuite/btgd/integration/rpctest
```
