...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/btgsuite/btgd/peer)
...
```bash
$ go get -u github.com/btgsuite/btgd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/btgsuite/btgd/peer#example-package--NewOutboundPeer)  
